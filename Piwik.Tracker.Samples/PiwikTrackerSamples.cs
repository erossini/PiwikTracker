...
namespace Piwik.Tracker.Samples
{
    ...
    class PiwikTrackerSamples
    {
        ...
        {
            PiwikTracker.URL = "http://analytics.westhill.co.uk";
...
//            RecordSimplePageView();
            ...
            {
                Console.WriteLine("Visit n. " + i);
                DateTime dt = GetRandomDateTime(new DateTime(2016, 2, 2, 0, 0, 0), new DateTime(2016, 2, 2, 23, 59, 59));
                GenerateVisits.RecordSimplePageViewWithCustomProperties(25, "f458a833a8acfb78d06e85e8e5f01d26", dt, dt);
            }
            for (int i = 0; i < 1947; i++)
            {
                Console.WriteLine("Visit n. " + i);
                DateTime dt = GetRandomDateTime(new DateTime(2016, 2, 3, 0, 0, 0), new DateTime(2016, 2, 3, 23, 59, 59));
                GenerateVisits.RecordSimplePageViewWithCustomProperties(25, "f458a833a8acfb78d06e85e8e5f01d26", dt, dt);
            }
            for (int i = 0; i < 1834; i++)
            {
                Console.WriteLine("Visit n. " + i);
                DateTime dt = GetRandomDateTime(new DateTime(2016, 2, 4, 0, 0, 0), new DateTime(2016, 2, 4, 23, 59, 59));
                GenerateVisits.RecordSimplePageViewWithCustomProperties(25, "f458a833a8acfb78d06e85e8e5f01d26", dt, dt);
            }
            for (int i = 0; i < 1769; i++)
            {
                Console.WriteLine("Visit n. " + i);
                DateTime dt = GetRandomDateTime(new DateTime(2016, 2, 5, 0, 0, 0), new DateTime(2016, 2, 5, 23, 59, 59));
                GenerateVisits.RecordSimplePageViewWithCustomProperties(25, "f458a833a8acfb78d06e85e8e5f01d26", dt, dt);
            }
            for (int i = 0; i < 854; i++)
            {
                Console.WriteLine("Visit n. " + i);
                DateTime dt = GetRandomDateTime(new DateTime(2016, 2, 6, 0, 0, 0), new DateTime(2016, 2, 6, 23, 59, 59));
                GenerateVisits.RecordSimplePageViewWithCustomProperties(25, "f458a833a8acfb78d06e85e8e5f01d26", dt, dt);
            }
            for (int i = 0; i < 782; i++)
            {
                Console.WriteLine("Visit n. " + i);
                DateTime dt = GetRandomDateTime(new DateTime(2016, 2, 7, 0, 0, 0), new DateTime(2016, 2, 7, 23, 59, 59));
                GenerateVisits.RecordSimplePageViewWithCustomProperties(25, "f458a833a8acfb78d06e85e8e5f01d26", dt, dt);
            }
