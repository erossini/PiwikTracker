...
namespace Piwik.Analytics.Samples
{
    ...
    {
        static string token = "f458a833a8acfb78d06e85e8e5f01d26";

        static void Main(string[] args)
        {
            try
            {
                PiwikAnalytics.URL = "http://analytics.westhill.co.uk";
        ...
        private static void AddMinimalSite()
        {
            ...
            siteManager.setTokenAuth(token);
        ...
        private static void GetBrowserMonthYesterday()
        {
            ...
            userSettings.setTokenAuth(token);
        ...
        private static void GetVisitFrequencyOnePeriod()
        {
            ...
            visitFrequency.setTokenAuth(token);
        ...
        private static int AddReport()
        {
            ...
            scheduledReports.setTokenAuth(token);
